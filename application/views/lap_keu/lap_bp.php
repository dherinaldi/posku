...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#cari").click(function(){
			...
			var data = {'tgl_awal':tgl_awal,'tgl_akhir':tgl_akhir,'tipe':tipe};
			$.ajax({
				url:"<?php echo base_url('laporan/lap_print/lap_bp');?>",
				type:"POST",
				data:data,
				cache:false,
			...
			<div class="box-body">
				<div class="table-responsive">
					<table class="table table-hover">
						<tbody>
							<input type="text" name="tipe" id="tipe" value="<?php echo $tipe;?>">
							<tr>
								<td>BKU</td>
								<td>
