...
<script type="text/javascript">
	$(document).ready(function(){
		$("#tampil").load("<?php echo base_url('jurnal/list_jurnal_umum');?>", {
		...
		$("#cari").click(function(){
			...
			$.ajax({
				url:"<?php echo base_url('jurnal/list_jurnal_umum');?>",
				type:"POST",
				data:dt,
				cache:false,
						...
						<tbody>
							...
							<tr>
								<td colspan="2">
									...
									<a class="btn btn-info btn-sm" href="<?php echo base_url('jurnal/add')?>" role="button">Tambah</a>
								</td>
