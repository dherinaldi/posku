...
<div class="row">
	<div class="col-md-3 col-sm-6 col-xs-12">
		<!--<div class="info-box"> -->
		<a href="<?=base_url('master/master/add_sub_jenis_belanja')?>" class="btn btn-sm btn-success">
						...
						<table class="table table-hover" id="tb_sasaran">
							...
							<tbody>
								...
								foreach ($q_sjb->result() as $key) {
									$id_sjb = $key->id_sub_jenis_belanja;
									$nama_sjb = $key->nama_sub_jenis;
									...
									<tr>
										...
										<td>
											<div class="btn-group">
											<a class="btn btn-sm bg-maroon" href="<?=base_url('master/master/edit_sub_jenis_belanja/'.$id_sjb)?>" role="button">Edit</a>
