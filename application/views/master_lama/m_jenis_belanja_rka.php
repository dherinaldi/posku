...
<div class="row">
	<div class="col-md-3 col-sm-6 col-xs-12">
		<!--<div class="info-box"> -->
		<a href="<?=base_url('master/master/add_jb_rka')?>" class="btn btn-sm btn-success">
					...
					<div class="table-responsive">
						<table class="table table-hover" id="tb_sasaran">
							...
							<tbody>
								<?
								$no=1;
								foreach ($q_jbr->result() as $key) {
									$id_jbr = $key->id_jb_rka;
									$nama_jbr = $key->nama_jb_rka;
									$id_bb = $key->id_bb;
									$nama_bb = $key->nama_bb;
									$id_mak = $key->id_mak;
									...
									<tr>
										...
										<td>
											<div class="btn-group">
											<a class="btn btn-sm bg-maroon" href="<?=base_url('master/master/edit_jb_rka/'.$id_jbr)?>" role="button">Edit</a>
