     ...
     <div class="box-body">
     	...
     	<table class="table table-hover">
     		<tbody>
     			<tr>
     				<td>Tanggal</td>
     				<td><input type="text" name="start" id="start" class="form-control" required="required" title="" placeholder="dd-mm-yyyy"></td>
     				<td>Tanggal</td>
     				<td><input type="text" name="end" id="end" class="form-control" required="required" title="" placeholder="dd-mm-yyyy"></td>
     			</tr>
     			<tr>
     				<td><button type="button" class="btn btn-info">Cari</button></td>
     			</tr>
     		</tbody>
     	</table>
     </div>
		...
		<div class="table-responsive">
			<table class="table table-hover" id="lap_master_barang">
				...
				?>
					<tr>
						<td><?php echo $no;?></td>
						<td><?php echo $dt->id_barang." ".$dt->nama_barang;?></td>
						<td><?php echo $dt->nama_satuan;?></td>
						<td><?php echo $dt->tanggal_pengadaan;?></td>
						<td><?php echo $dt->id_pengadaan." ".$dt->kd_pengadaan;?></td>
						...
						<td><?php echo $dt->id_pengeluaran." ".$dt->kd_pengeluaran;;?></td>
